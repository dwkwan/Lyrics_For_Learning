...
@app_views.route('/interpretations/<word_id>/<song_id>', methods=['GET'], strict_slashes=False)
...
@app_views.route('/interpretations/<interpretation_id>', methods=['PUT'], strict_slashes=False)
